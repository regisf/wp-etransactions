...
require_once plugin_dir_path(__FILE__) . 'productsdb.php';

class ETransaction_TransactionDB
{
    ...
    private function __construct()
    {
        ...
        $this->db_product_name = $this->db->prefix . ETransactions_DbPrefix . ETransaction_ProductDB::DbName;
    }

    public static function get_instance()
    {
        if (self::$instance === null) {
            self::$instance = new ETransaction_TransactionDB();
        }
